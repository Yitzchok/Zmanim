...
namespace Zmanim.Scheduling
{
    ...
    /*public class ZmanimTrigger : ZmanimTrigger
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="ZmanimTrigger"/> class.
        /// </summary>
        ...
        public ZmanimTrigger(Location location, Func<ComplexZmanimCalendar, Date> executeOnZman)
        {
            Location = location;
        ...
        /// <summary>
        /// Create a <see cref="ZmanimTrigger"/> that will occur immediately, and
        ...
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, string group, int repeatCount, TimeSpan repeatInterval, Location location)
            : this(name, group, DateTime.UtcNow, null, repeatCount, repeatInterval, location)
        {
        }
        ...
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, DateTime startTimeUtc, Location location)
            : this(name, null, startTimeUtc, location)
        {
        }
        ...
        /// <param name="startTimeUtc">The start time UTC.</param>
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, string group, DateTime startTimeUtc, Location location)
            : this(name, group, startTimeUtc, null, 0, TimeSpan.Zero, location)
        {
        }
        ...
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, DateTime startTimeUtc,
             DateTime? endTimeUtc, int repeatCount, TimeSpan repeatInterval, Location location)
            : this(name, null, startTimeUtc, endTimeUtc, repeatCount, repeatInterval, location)
        {
        }
        ...
        /// <param name="repeatInterval">The time span to pause between the repeat firing.</param>
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, string group, DateTime startTimeUtc,
            DateTime? endTimeUtc, int repeatCount, TimeSpan repeatInterval, Location location)
            : base(name, group, startTimeUtc, endTimeUtc, repeatCount, repeatInterval)
        {
            Location = location;
        }
        ...
        /// <param name="repeatInterval">The time span to pause between the repeat firing.</param>
        /// <param name="location">The location.</param>
        public ZmanimTrigger(string name, string group, string jobName, string jobGroup, DateTime startTimeUtc,
                  DateTime? endTimeUtc, int repeatCount, TimeSpan repeatInterval, Location location)
            : base(name, group, jobName, jobGroup, startTimeUtc, endTimeUtc, repeatCount, repeatInterval)
        {
            Location = location;
        }
        ...
        {
            return ExecuteOnZman.Invoke(new ComplexZmanimCalendar(
                new GeoLocation(string.Empty, Location.Latitude, Location.Longitude, Location.Elevation, java.util.TimeZone.getTimeZone(Location.TimeZone)))
                ).ToDateTimeWithMilliseconds().ToUniversalTime();
        }

        public override DateTime? GetFireTimeAfter(DateTime? afterTimeUtc)
        {
            return base.GetFireTimeAfter(afterTimeUtc);
        }

        public override DateTime? GetFireTimeBefore(DateTime? endUtc)
        {
            return base.GetFireTimeBefore(endUtc);
        }
    }
