...
namespace net.sourceforge.zmanim
{
    ...
    public class AstronomicalCalendar : ICloneable
    {
        ...
        */
        ...
        /// <summary> Sun's zenith at civil twilight (96°).  </summary>
        public const double CIVIL_ZENITH = 96;

        /// <summary> Sun's zenith at nautical twilight (102°).  </summary>
        public const double NAUTICAL_ZENITH = 102;

        /// <summary> Sun's zenith at astronomical twilight (108°).  </summary>
