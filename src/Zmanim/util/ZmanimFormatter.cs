...
namespace net.sourceforge.zmanim.util
{
    ...
    ///
    /// <summary> * A class used to format non <seealso cref="java.util.Date"/> times generated by the
    ...
    public class ZmanimFormatter
    {
        ...
        ///    
        ///	 <summary> * Format using hours, minutes, seconds and milliseconds using the xsd:time
        ...
        ///    
        ///	 <summary> * Format using the XSD Duration format. This is in the format of
        ...
        ///    
        ///	 <summary> * ZmanimFormatter constructor using a formatter
        ///	 *  </summary>
        ///	 * <param name="format">
        ...
        ///    
        ///	 <summary> * Sets the format to use for formatting.
        ///	 *  </summary>
        ///	 * <param name="format">
        ...
        ///    
        ///	 <summary> * A method that formats milliseconds into a time format.
        ///	 *  </summary>
        ...
        ///    
        ///	 <summary> * A method that formats <seealso cref="Time"/>objects.
        ///	 *  </summary>
        ///	 * <param name="time">
        ...
        ///    
        ///	 <summary> * Formats a date using this classe's <seealso cref="#getDateFormat() date format"/>.
        ///	 *  </summary>
        ///	 * <param name="Date">
        ...
        ///    
        ///	 <summary> * The date:date-time function returns the current date and time as a
        ...
        ///    
        ///	 <summary> * Represent the hours and minutes with two-digit strings.
        ///	 *  </summary>
        ...
        ///    
        ///	 <summary> * This returns the xml representation of an xsd:duration object.
        ///	 *  </summary>
        ...
        {
            ZmanimFormatter formatter = new ZmanimFormatter(ZmanimFormatter.XSD_DURATION_FORMAT, new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss"));
            ...
            output += " type=\"" + ac.GetType().Name + "\"";
            output += " algorithm=\"" + ac.getAstronomicalCalculator().getCalculatorName() + "\"";
            ...
            output += " timeZoneName=\"" + ac.getGeoLocation().getTimeZone().getDisplayName() + "\"";
            output += " timeZoneID=\"" + ac.getGeoLocation().getTimeZone().getID() + "\"";
            output += " timeZoneOffset=\"" + (ac.getGeoLocation().getTimeZone().getOffset(ac.getCalendar().getTimeInMillis()) / ((double)HOUR_MILLIS)) + "\"";
            ...
            foreach (var zman in dateList.OrderBy(x => x.getZman()))
            {
                ...
                output += ">";
                output += formatter.formatDate(zman.getZman(), ac.getCalendar())
                        + "</" + zman.getZmanLabel() + ">\n";
            }

            foreach (var zman in dateList.OrderBy(x => x.getDuration()))
            {
                output += "\t<" + zman.getZmanLabel();
                output += ">";
            ...
            {
                zman = (Zman)dateList[i];
                output += "\t<" + zman.getZmanLabel();
                output += ">";
                output += formatter.formatDate(zman.getZman(), ac.getCalendar()) + "</" + zman.getZmanLabel() + ">\n";
            }
            Collections.sort(durationList, Zman.DURATION_ORDER);
            for (int i = 0; i < durationList.Count; i++)
            {
                zman = (Zman)durationList[i];
                output += "\t<" + zman.getZmanLabel();
                output += ">";
                output += formatter.format((int)zman.getDuration()) + "</" + zman.getZmanLabel() + ">\n";
            }

            for (int i = 0; i < otherList.Count; i++) // will probably never enter
            {
                // this block
                output += "\t" + otherList[i] + "\n";
            }
        ...
        private static bool includeMethod(MethodInfo method)
        {
            ...
            if (method.ReturnType.Name.EndsWith("Date")
                    || method.ReturnType.Name.EndsWith("long"))
            {
                return true;
            }
            return false;
