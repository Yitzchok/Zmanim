...
namespace net.sourceforge.zmanim.util
{
    public class NOAACalculator : AstronomicalCalculator
    {
        ...
        private static double calcEquationOfTime(double num1)
        {
            ...
            double num5 = Math.tan(Math.toRadians(angdeg)/2.0);
            num5 *= num5;
            double num6 = Math.sin(2.0*Math.toRadians(num2));
            double num7 = Math.sin(Math.toRadians(num4));
            double num8 = Math.cos(2.0*Math.toRadians(num2));
            double num9 = Math.sin(4.0*Math.toRadians(num2));
            double num10 = Math.sin(2.0*Math.toRadians(num4));
            double angrad = ((((num5*num6) - ((2.0*num3)*num7)) + ((((4.0*num3)*num5)*num7)*num8)) -
                             (((0.5*num5)*num5)*num9)) - (((1.25*num3)*num3)*num10);
        ...
        private static double calcHourAngleSunrise(double num1, double num4, double num5)
        {
            ...
            double num2 = Math.toRadians(num4);
            return
                Math.acos((Math.cos(Math.toRadians(num5))/(Math.cos(a)*Math.cos(num2))) - (Math.tan(a)*Math.tan(num2)));
        }
        ...
        private static double calcJD(Calendar calendar1)
        {
            ...
            double num4 = Math.floor((num/100));
            double num5 = (2.0 - num4) + Math.floor(num4/4.0);
            return ((((Math.floor(365.25*(num + 0x126c)) + Math.floor(30.6001*(num2 + 1))) + num3) + num5) - 1524.5);
        }
        ...
        private static double calcObliquityCorrection(double num1)
        {
            ...
            return (num + (0.00256*Math.cos(Math.toRadians(angdeg))));
        }
        ...
        private static double calcSunApparentLong(double num1)
        {
            ...
            double angdeg = 125.04 - (1934.136*num1);
            return ((num - 0.00569) - (0.00478*Math.sin(Math.toRadians(angdeg))));
        }
        ...
        private static double calcSunEqOfCenter(double num1)
        {
            ...
            double num4 = Math.sin(a + a);
            double num5 = Math.sin((a + a) + a);
            return (((num3*(1.914602 - (num1*(0.004817 + (1.4E-05*num1))))) + (num4*(0.019993 - (0.000101*num1)))) +
                    (num5*0.000289));
        }
        ...
        private static double calcSunriseUTC(double num1, double num12, double num11, double num13)
        {
            ...
            double num7 = num11 - Math.toDegrees(angrad);
            ...
            num7 = num11 - Math.toDegrees(angrad);
            num8 = 4.0*num7;
                                             ...
                                             bool adjustForElevation)
        {
            ...
            double num2 = calcSunriseUTC(calcJD(astronomicalCalendar.getCalendar()),
                                            ...
                                            bool adjustForElevation)
        {
            ...
            double num2 = calcSunsetUTC(calcJD(astronomicalCalendar.getCalendar()),
                                        astronomicalCalendar.getGeoLocation().getLatitude(),
                                        -astronomicalCalendar.getGeoLocation().getLongitude(), zenith);
            return (num2/60.0);
        }
