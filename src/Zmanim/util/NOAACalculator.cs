...
namespace net.sourceforge.zmanim.util
{
    ...
    public class NOAACalculator : AstronomicalCalculator
    {
        ...
        ///	<seealso cref="net.sourceforge.zmanim.util.AstronomicalCalculator.getUTCSunrise(AstronomicalCalendar,double, boolean)"/>
        public override double getUTCSunrise(AstronomicalCalendar astronomicalCalendar, double zenith, bool adjustForElevation)
        {
            ...
            double sunRise = calcSunriseUTC(calcJD(astronomicalCalendar.getCalendar()), astronomicalCalendar.getGeoLocation().getLatitude(), -astronomicalCalendar.getGeoLocation().getLongitude(), zenith);
            return sunRise / 60;
        }
        ...
        public override double getUTCSunset(AstronomicalCalendar astronomicalCalendar, double zenith, bool adjustForElevation)
        {
            ...
            double sunSet = calcSunsetUTC(calcJD(astronomicalCalendar.getCalendar()), astronomicalCalendar.getGeoLocation().getLatitude(), -astronomicalCalendar.getGeoLocation().getLongitude(), zenith);
            return sunSet / 60;
        }

        ///    
        ///	 <summary> * Generate a Julian day from Java Calendar
        ///	 * </summary>
        ///	 * <param name="date">
        ///	 *            Java Calendar </param>
        ...
        private static double calcJD(Calendar date)
        {
            ...
            double A = System.Math.Floor((double)(year / 100));
            double B = 2 - A + System.Math.Floor(A / 4);

            return System.Math.Floor(365.25 * (year + 4716)) + System.Math.Floor(30.6001 * (month + 1)) + day + B - 1524.5;
        }
        ...
        ///    
        ///	 <summary> * calculates the Geometric Mean Longitude of the Sun
        ///	 * </summary>
        ///	 * <param name="t">
        ///	 *            the number of Julian centuries since J2000.0 </param>
        ...
        ///    
        ///	 <summary> * Calculate the equation of center for the sun
        ///	 * </summary>
        ///	 * <param name="t">
        ///	 *            the number of Julian centuries since J2000.0 </param>
        ...
        private static double calcSunEqOfCenter(double t)
        {
            ...
            double sinm = System.Math.Sin(mrad);
            double sin2m = System.Math.Sin(mrad + mrad);
            double sin3m = System.Math.Sin(mrad + mrad + mrad);
        ...
        private static double calcSunApparentLong(double t)
        {
            ...
            double lambda = o - 0.00569 - 0.00478 * System.Math.Sin(Math.toRadians(omega));
        ...
        private static double calcObliquityCorrection(double t)
        {
            ...
            double omega = 125.04 - 1934.136 * t;
            double e = e0 + 0.00256 * System.Math.Cos(Math.toRadians(omega));
            return e; // in degrees
        }
        ...
        private static double calcSunDeclination(double t)
        {
            ...
            double theta = Math.toDegrees(System.Math.Asin(sint));
        ...
        private static double calcEquationOfTime(double t)
        {
            ...
            double y = System.Math.Tan(Math.toRadians(epsilon) / 2.0);
            y *= y;

            double sin2l0 = System.Math.Sin(2.0 * Math.toRadians(l0));
            double sinm = System.Math.Sin(Math.toRadians(m));
            double cos2l0 = System.Math.Cos(2.0 * Math.toRadians(l0));
            double sin4l0 = System.Math.Sin(4.0 * Math.toRadians(l0));
            double sin2m = System.Math.Sin(2.0 * Math.toRadians(m));
        ...
        ///    
        ///	 <summary> * Calculate the hour angle of the sun at sunrise for the latitude
        ///	 * </summary>
        ///	 * <param name="lat">,
        ...
        private static double calcHourAngleSunrise(double lat, double solarDec, double zenith)
        {
            ...
            double HA = (System.Math.Acos(System.Math.Cos(Math.toRadians(zenith)) / (System.Math.Cos(latRad) * System.Math.Cos(sdRad)) - System.Math.Tan(latRad) * System.Math.Tan(sdRad)));
            return HA; // in radians
        }

        ///    
        ///	 <summary> * Calculate the hour angle of the sun at sunset for the latitude
        ///	 * </summary>
        ///	 * <param name="lat">
        ///	 *            the latitude of observer in degrees </param>
        ///	 * <param name="solarDec">
        ...
        ///    
        ///	 <summary> * Calculate the Universal Coordinated Time (UTC) of sunrise for the given
        ...
        ///    
        ///	 <summary> * calculate the Universal Coordinated Time (UTC) of solar noon for the
        ...
        ///    
        ///	 <summary> * calculate the Universal Coordinated Time (UTC) of sunset for the given
        ///	 * day at the given location on earth
        ///	 * </summary>
        ///	 * <param name="JD">
        ///	 *            the julian day </param>
